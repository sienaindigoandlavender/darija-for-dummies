...
export const metadata: Metadata = {
  ...
  description: 'The complete guide to Darija grammar: pronouns, verb conjugation (ka-/past/ghadi), negation (ma...sh), adjective agreement, and the sound system. By J. Ng.',
  openGraph: {
